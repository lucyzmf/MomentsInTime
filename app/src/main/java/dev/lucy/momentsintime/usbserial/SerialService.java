...
/**
 * Background service that manages USB serial connections
 * Creates notification and queues serial data while activity is not in the foreground
...
public class SerialService extends Service implements SerialListener {
     ...
     * 
     * @param socket The serial socket to connect to
     * @throws IOException If connection fails
     */
    public void connect(SerialSocket socket) throws IOException {
        Log.d(TAG, "Connecting to " + socket.getName());
        try {
            socket.connect(this);
            this.socket = socket;
            connected = true;
    ...
    private void createNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, Constants.NOTIFICATION_CHANNEL)
                ...
                .setColor(0xFF3F51B5) // Default primary color
                .setContentTitle("USB Serial")
                .setContentText(socket != null ? "Connected to "+socket.getName() : "Background Service")
                .setContentIntent(restartPendingIntent)
                .setOngoing(true)
                .addAction(new NotificationCompat.Action(android.R.drawable.ic_menu_close_clear_cancel, "Disconnect", disconnectPendingIntent));
